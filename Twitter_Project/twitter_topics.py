...
print "got our unique users", len(unique_accounts)
...
if doc == None:
    ...
    db.tweets.update_one(
        {"query": query},
        {"$set": {"unique_accounts":  doc['unique_accounts'] + list(unique_accounts), "tweet_data": dict(doc['tweet_data'].items() + accounts_object.items()), "id_tweet_map": doc['id_tweet_map'] + id_tweet_map, "max_id": final_max_id}, "$currentDate": {"lastModified": True}})
